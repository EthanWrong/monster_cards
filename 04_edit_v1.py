...
TK = {"Strength": 0, "Speed": 1, "Stealth": 2, "Cunning": 3,
      0: "Strength", 1: "Speed", 2: "Stealth", 3: "Cunning"}  # Trait Key
...
def edit_card(card, cat=card_cat):
    ...
    if choice == "Rename":
        ...
        msg = f"**{card[0]}'s** {choice}: {card[1][TK[choice]]}\n\n" \
              f"Set a new value"
        card[1][TK[choice]] = set_new_trait(msg, "Edit Card", card[1][TK[
            choice]])
        print(card)
        return edit_card(card)
