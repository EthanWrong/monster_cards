...
Copied code from 00v1, more info there.

Adjusted search_card() to simply return a card

Functional, but not bug-tested.
Printing not formatted nicely.
"""
...
def main(cat=card_cat):
    ...
    choice = buttonbox("Wat next?", title,
